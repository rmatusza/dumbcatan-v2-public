...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleExpiredJwtError(ExpiredJwtException ex) {
        return new ResponseEntity<>(new ApiResponse("JWT is expired", 401),
                HttpStatus.UNAUTHORIZED);
    }

    @ExceptionHandler(JwtException.class)
    public ResponseEntity<ApiResponse> handleInvalidJwtError(JwtException ex) {
    ...
    public ResponseEntity<ApiResponse> handleDuplicateInviteError(DuplicateInviteException ex) {
        return new ResponseEntity<>(new ApiResponse(ex.getMessage(), 403),
                HttpStatus.UNAUTHORIZED);
    }
